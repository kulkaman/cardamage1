...
var PostsService = (function () {
    ...
    PostsService.url = 'https://0a5c78f5.ngrok.io';
...
var AboutComponent = (function () {
    function AboutComponent(postsService) {
        ...
        if (this.posts) {
            ...
            this.pdfSrc = "https://0a5c78f5.ngrok.io/SpringMVC/pdf/" + this.posts[0].rentalAgreementNumber + "_file.pdf";
        }
    }
...
var UserComponent = (function () {
    function UserComponent(postsService, router) {
        ...
        if (this.posts) {
            ...
            this.pdfSrc = "https://0a5c78f5.ngrok.io/SpringMVC/pdf/" + this.rentalAgreementNumber + "_file.pdf";
        }
        if (this.coDate == null) {
