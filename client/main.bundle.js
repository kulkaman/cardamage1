...
var PostsService = (function () {
    ...
    PostsService.url = 'https://6e756add.ngrok.io';
...
var AboutComponent = (function () {
     ...
     */
        if (this.posts) {
            ...
            this.pdfSrc = "https://6e756add.ngrok.io/SpringMVC/pdf/" + this.posts[0].rentalAgreementNumber + "_file.pdf";
        }
    }
...
var UserComponent = (function () {
    function UserComponent(postsService, router) {
        ...
        if (this.posts) {
            ...
            this.pdfSrc = "https://6e756add.ngrok.io/SpringMVC/pdf/" + this.rentalAgreementNumber + "_file.pdf";
        }
        if (this.coDate == null) {
    ...
    AppComponent.prototype.checkClaim = function (path) {
        ...
        this.postsService.getPosts(this.raNumber, this.lastName, this.claimNumber).subscribe(function (posts) {
            ...
            if (path == 'new' || _this.posts[0].claimNumber != null) {
                _this.loadingResultsNewFetched = false;
                _this.loadingResultsViewFetched = false;
