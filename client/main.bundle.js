...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs__ = __webpack_require__(715);
...
var PostsService = (function () {
    ...
    PostsService.prototype.getPosts = function (raNumber, lastName, claimNumber) {
        ...
        var abc = PostsService.url + '/SpringMVC/rest/radetails/' + raNumber + '/' + lastName + '/';
    ...
    PostsService.prototype.updateClaimDetails = function (newClaim) {
        ...
        return this.http.put('http://localhost:8080/SpringMVC/rest/radetails/', newClaim, options)
            .map(function (res) { return res.json(); });
        //.catch(this.handleErrorObservable);
        // .subscribe();
    };
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_posts_service__ = __webpack_require__(245);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_angular2_signaturepad_signature_pad__ = __webpack_require__(246);
...
var AboutComponent = (function () {
    ...
    AboutComponent.prototype.updateClaim = function () {
        ...
        this._newClaim.policeReportNumber = this.incidentPoliceRpt;
...
var UserComponent = (function () {
    ...
    UserComponent.prototype.createClaim = function () {
        ...
        this.postsService.getClaimNumberPosts(this._newClaim).subscribe(function (response) {
            console.log("regular response" + response);
            (function (response) { return response.json(); });
            this.successClaim = true;
            this.claimNumber = response;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_posts_service__ = __webpack_require__(245);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_router__ = __webpack_require__(358);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_angular2_signaturepad__ = __webpack_require__(556);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__node_modules_angular2_ui_switch_src__ = __webpack_require__(550);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__node_modules_ng2_img_map__ = __webpack_require__(709);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_user_component__ = __webpack_require__(365);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__components_about_component__ = __webpack_require__(364);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__app_routing__ = __webpack_require__(554);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_router__ = __webpack_require__(358);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_user_component__ = __webpack_require__(365);
...
module.exports = "<link href=\"https://fonts.googleapis.com/icon?family=Material+Icons\"\r\n\trel=\"stylesheet\">\r\n<script type=\"text/javascript\" src=\"webcam.js\"></script>\r\n\r\n\r\n\r\n\r\n<div class=\"jumbotron\">\r\n\t<div class=\"container\">\r\n\r\n\r\n\t\t<div class=\"panel panel-default\">\r\n\t\t\t<div *ngIf=\"readOnlyMode\">\r\n\t\t\t\t<!-- Default panel contents -->\r\n\t\t\t\t<div class=\"panel-heading\">\r\n\t\t\t\t\tIncident Details&nbsp;&nbsp;&nbsp;<span><i\r\n\t\t\t\t\t\t(click)=\"editClaim()\" class=\"material-icons\">&#xe254;</i></span>\r\n\t\t\t\t</div>\r\n\r\n\t\t\t\t<!-- Table -->\r\n\t\t\t\t<table class=\"table\">\r\n\t\t\t\t\t<tbody>\r\n\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t<td width=\"30%\" bgcolor=\"red\"><font color=\"white\">Renter\r\n\t\t\t\t\t\t\t\t\tName</font></td>\r\n\t\t\t\t\t\t\t<td width=\"70%\">{{renterName}}</td>\r\n\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t<td bgcolor=\"red\" width=\"30%\"><font color=\"white\">Claim\r\n\t\t\t\t\t\t\t\t\tNumber</font></td>\r\n\t\t\t\t\t\t\t<td width=\"70%\">{{claimNumber}}</td>\r\n\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t<td bgcolor=\"red\" width=\"30%\"><font color=\"white\">Claim\r\n\t\t\t\t\t\t\t\t\tStatus</font></td>\r\n\t\t\t\t\t\t\t<td width=\"70%\">{{claimStatus}}</td>\r\n\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t<td bgcolor=\"red\" width=\"30%\"><font color=\"white\">Rental\r\n\t\t\t\t\t\t\t\t\tAgreement #</font></td>\r\n\t\t\t\t\t\t\t<td width=\"70%\">{{raNumber}}</td>\r\n\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t<td bgcolor=\"red\" width=\"30%\"><font color=\"white\">MVA\r\n\t\t\t\t\t\t\t\t\tNumber</font></td>\r\n\t\t\t\t\t\t\t<td width=\"70%\">{{mvaNumber}}</td>\r\n\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t<td bgcolor=\"red\" width=\"30%\"><font color=\"white\">Date\r\n\t\t\t\t\t\t\t\t\tof Incident</font></td>\r\n\t\t\t\t\t\t\t<td width=\"70%\">Jul 13, 2017, 3:00:53 PM</td>\r\n\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t<td bgcolor=\"red\" width=\"30%\"><font color=\"white\">City</font></td>\r\n\t\t\t\t\t\t\t<td width=\"70%\" >{{incidentCity}}</td>\r\n\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t<td bgcolor=\"red\" width=\"30%\"><font color=\"white\">State</font></td>\r\n\t\t\t\t\t\t\t<td width=\"70%\">{{incidentState}}</td>\r\n\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t<td bgcolor=\"red\" width=\"30%\"><font color=\"white\">Zip\r\n\t\t\t\t\t\t\t\t\tCode</font></td>\r\n\t\t\t\t\t\t\t<td width=\"70%\">{{incidentZipCode}}</td>\r\n\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t<td bgcolor=\"red\" width=\"30%\"><font color=\"white\">Police\r\n\t\t\t\t\t\t\t\t\tRpt #</font></td>\r\n\t\t\t\t\t\t\t<td width=\"70%\">{{incidentPoliceRpt}}</td>\r\n\t\t\t\t\t\t</tr>\r\n\r\n\t\t\t\t\t</tbody>\r\n\t\t\t\t</table>\r\n\t\t\t\t<div *ngIf=\"claimStatus=='Open'\">\r\n\t\t\t\t\t<table class=\"table\">\r\n\t\t\t\t\t\t<tbody>\r\n\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t<td bgcolor=\"red\" width=\"30%\"><font color=\"white\">Payment\r\n\t\t\t\t\t\t\t\t\t\tDue</font></td>\r\n\t\t\t\t\t\t\t\t<td width=\"70%\">{{paymentDue}}</td>\r\n\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t<td bgcolor=\"red\" width=\"30%\"><font color=\"white\">Payment\r\n\t\t\t\t\t\t\t\t\t\tReceived</font></td>\r\n\t\t\t\t\t\t\t\t<td width=\"70%\">{{paymentReceived}}</td>\r\n\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t<td bgcolor=\"red\" width=\"30%\"><font color=\"white\">Payment\r\n\t\t\t\t\t\t\t\t\t\tOptions</font></td>\r\n\t\t\t\t\t\t\t\t<td width=\"70%\">Please contact\r\n\t\t\t\t\t\t\t\t\tAvisBudgetHelp@SedgwickClaims.com</td>\r\n\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t<!-- \t<tr>\r\n\t\t\t\t\t\t\t<td>Damage Description</td>\r\n\t\t\t\t\t\t\t<td><div class=\"input-group\">\r\n\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\"\r\n\t\t\t\t\t\t\t\t\t\tplaceholder=\"Provide Damage Description\"\r\n\t\t\t\t\t\t\t\t\t\taria-describedby=\"basic-addon1\"\r\n\t\t\t\t\t\t\t\t\t\t[(ngModel)]=\"partyDamageDescription\"\r\n\t\t\t\t\t\t\t\t\t\tname=\"partyDamageDescription\">\r\n\t\t\t\t\t\t\t\t</div></td>\r\n\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t<td>Drivable Car</td>\r\n\t\t\t\t\t\t\t<td><div class=\"checkbox\">\r\n\t\t\t\t\t\t\t\t\t<label> <input type=\"checkbox\" data-toggle=\"toggle-one\"\r\n\t\t\t\t\t\t\t\t\t\tchecked data-toggle=\"toggle\" [(ngModel)]=\"drivableCarInd\"\r\n\t\t\t\t\t\t\t\t\t\tname=\"drivableCarInd\">\r\n\r\n\t\t\t\t\t\t\t\t\t</label>\r\n\t\t\t\t\t\t\t\t</div></td>\r\n\t\t\t\t\t\t</tr>\r\n\r\n\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t<td>Licensee Plate</td>\r\n\t\t\t\t\t\t\t<td><div class=\"input-group\">\r\n\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\"\r\n\t\t\t\t\t\t\t\t\t\tplaceholder=\"Licensee Plate of Impacted Vehicle\"\r\n\t\t\t\t\t\t\t\t\t\taria-describedby=\"basic-addon1\"\r\n\t\t\t\t\t\t\t\t\t\t[(ngModel)]=\"partyLicensePlate\" name=\"partyLicensePlate\">\r\n\t\t\t\t\t\t\t\t</div></td>\r\n\t\t\t\t\t\t</tr> -->\r\n\t\t\t\t\t\t</tbody>\r\n\t\t\t\t\t</table>\r\n\t\t\t\t</div>\r\n\r\n\r\n\r\n\r\n\t\t\t\t<br />\r\n\r\n\r\n\r\n\t\t\t\t<div class=\"panel panel-default\">\r\n\t\t\t\t\t<div class=\"panel-heading\">\r\n\t\t\t\t\t\tInsurance Details&nbsp;&nbsp;&nbsp;<span><i\r\n\t\t\t\t\t\t(click)=\"editClaim()\" class=\"material-icons\">&#xe254;</i></span>\r\n\t\t\t\t\t</div>\r\n\r\n\t\t\t\t\t<table class=\"table\">\r\n\t\t\t\t\t\t<tbody>\r\n\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t<td bgcolor=\"red\" width=\"30%\"><font color=\"white\">Name</font></td>\r\n\t\t\t\t\t\t\t\t<td width=\"70%\">{{insuranceName}}</td>\r\n\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t<td bgcolor=\"red\" width=\"30%\"><font color=\"white\">Address</font></td>\r\n\t\t\t\t\t\t\t\t<td width=\"70%\">{{insuranceAddress}}</td>\r\n\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t<!-- <tr>\r\n\t\t\t\t\t\t<td>Is Operator's Details same as Renter ?</td>\r\n\t\t\t\t\t\t<td><div class=\"checkbox\">\r\n\t\t\t\t\t\t\t\t<label> <input type=\"checkbox\" data-toggle=\"toggle-one\"\r\n\t\t\t\t\t\t\t\t\t(click)=\"toggleHobbies()\">\r\n\r\n\t\t\t\t\t\t\t\t</label>\r\n\t\t\t\t\t\t\t</div></td>\r\n\t\t\t\t\t</tr> -->\r\n\t\t\t\t\t\t</tbody>\r\n\t\t\t\t\t</table>\r\n\r\n\t\t\t\t\t<!-- <div *ngIf=\"showHobbies\">\r\n\t\t\t\t<table class=\"table\">\r\n\t\t\t\t\t<tbody>\r\n\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t<td>Name</td>\r\n\t\t\t\t\t\t\t<td><div class=\"input-group\">\r\n\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\"\r\n\t\t\t\t\t\t\t\t\t\tplaceholder=\"Person operating vehicle\"\r\n\t\t\t\t\t\t\t\t\t\taria-describedby=\"basic-addon1\"\r\n\t\t\t\t\t\t\t\t\t\t[(ngModel)]=\"operatorName\" name = \"operatorName\"\r\n\t\t\t\t\t\t\t\t\t\t>\r\n\t\t\t\t\t\t\t\t</div></td>\r\n\t\t\t\t\t\t</tr>\r\n\r\n\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t<td>Contact</td>\r\n\t\t\t\t\t\t\t<td><div class=\"input-group\">\r\n\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\"\r\n\t\t\t\t\t\t\t\t\t\tplaceholder=\"Operators contact number\"\r\n\t\t\t\t\t\t\t\t\t\taria-describedby=\"basic-addon1\"\r\n\t\t\t\t\t\t\t\t\t\t[(ngModel)]=\"operatorContact\" name = \"operatorContact\">\r\n\t\t\t\t\t\t\t\t</div></td>\r\n\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t<td>Email</td>\r\n\t\t\t\t\t\t\t<td><div class=\"input-group\">\r\n\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\"\r\n\t\t\t\t\t\t\t\t\t\tplaceholder=\"Operator Email Address\"\r\n\t\t\t\t\t\t\t\t\t\taria-describedby=\"basic-addon1\"\r\n\t\t\t\t\t\t\t\t\t\t[(ngModel)]=\"operatorEmail\" name = \"operatorEmail\">\r\n\t\t\t\t\t\t\t\t</div></td>\r\n\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t<td>Address</td>\r\n\t\t\t\t\t\t\t<td><div class=\"input-group\">\r\n\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\"\r\n\t\t\t\t\t\t\t\t\t\tplaceholder=\"Operators Address\"\r\n\t\t\t\t\t\t\t\t\t\taria-describedby=\"basic-addon1\"\r\n\t\t\t\t\t\t\t\t\t\t[(ngModel)]=\"operatorAddress\" name = \"operatorAddress\">\r\n\t\t\t\t\t\t\t\t</div></td>\r\n\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t<td>Zipcode</td>\r\n\t\t\t\t\t\t\t<td><div class=\"input-group\">\r\n\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\"\r\n\t\t\t\t\t\t\t\t\t\tplaceholder=\"Operators Zip code\"\r\n\t\t\t\t\t\t\t\t\t\taria-describedby=\"basic-addon1\"\r\n\t\t\t\t\t\t\t\t\t\t[(ngModel)]=\"operatorZipCode\" name = \"operatorZipCode\">\r\n\t\t\t\t\t\t\t\t</div></td>\r\n\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t<td>License Number</td>\r\n\t\t\t\t\t\t\t<td><div class=\"input-group\">\r\n\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\"\r\n\t\t\t\t\t\t\t\t\t\tplaceholder=\"Operators Licensee Number\"\r\n\t\t\t\t\t\t\t\t\t\taria-describedby=\"basic-addon1\"\r\n\t\t\t\t\t\t\t\t\t\t[(ngModel)]=\"operatorLicenseeNumber\" name = \"operatorLicenseeNumber\">\r\n\t\t\t\t\t\t\t\t</div></td>\r\n\t\t\t\t\t\t</tr>\r\n\r\n\t\t\t\t\t</tbody>\r\n\t\t\t\t</table>\r\n\t\t\t</div> -->\r\n\r\n\t\t\t\t</div>\r\n\r\n\r\n\r\n\r\n\r\n\t\t\t\t<div class=\"panel panel-default\">\r\n\t\t\t\t\t<div class=\"panel-heading\">\r\n\t\t\t\t\t\tCar Damage Details&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span><i\r\n\t\t\t\t\t\t(click)=\"editClaim()\" class=\"material-icons\">&#xe254;</i></span>\r\n\t\t\t\t\t</div>\r\n\t\t\t\t\t<table class=\"table\">\r\n\t\t\t\t\t\t<tbody>\r\n\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t<td bgcolor=\"red\" width=\"30%\"><font color=\"white\">Description</font></td>\r\n\t\t\t\t\t\t\t\t<td width=\"70%\">{{damageDescription}}</td>\r\n\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t<td bgcolor=\"red\" width=\"30%\"><font color=\"white\">Policy\r\n\t\t\t\t\t\t\t\t\t\tNumber</font></td>\r\n\t\t\t\t\t\t\t\t<td width=\"70%\">{{policyNumber}}</td>\r\n\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t<td bgcolor=\"red\" width=\"30%\"><font color=\"white\">Damage\r\n\t\t\t\t\t\t\t\t\t\tSeverity</font></td>\r\n\t\t\t\t\t\t\t\t<td width=\"70%\">{{damageSeverity}}</td>\r\n\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t</tbody>\r\n\t\t\t\t\t</table>\r\n\t\t\t\t</div>\r\n\r\n\t\t\t</div>\r\n\r\n\r\n\t\t\t<div *ngIf=\"editMode\">\r\n\t\t\t\t<div class=\"panel panel-default\">\r\n\t\t\t\t\t<!-- Default panel contents -->\r\n\t\t\t\t\t<div class=\"panel-heading\">Incident Details</div>\r\n\r\n\t\t\t\t\t<!-- Table -->\r\n\t\t\t\t\t<table class=\"table\">\r\n\t\t\t\t\t\t<tbody>\r\n\t\t\t\t\t\t\t<!-- <tr>\r\n\t\t\t\t\t\t\t\t<td bgcolor=\"red\" width=\"30%\"><font color=\"white\">Date\r\n\t\t\t\t\t\t\t\t\t\tof Incident</font></td>\r\n\t\t\t\t\t\t\t\t<td width=\"70%\"><input id=\"incidentDate\" type=\"date\" value=\"2011-01-13\"></td>\r\n\t\t\t\t\t\t\t\t<td width=\"70%\"><input id=\"incidentDate\" type=\"date\"\r\n\t\t\t\t\t\t\t\t\tvalue=\"2017-07-14\"><input id=\"incidentTime\" type=\"time\"></td>\r\n\t\t\t\t\t\t\t\t<td><span>{{whatTime | date: 'yyyy-MM-dd'}}</span></td>\r\n\t\t\t\t\t\t\t</tr> -->\r\n\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t<td bgcolor=\"red\" width=\"30%\"><font color=\"white\">City</font></td>\r\n\t\t\t\t\t\t\t\t<td width=\"70%\"><div class=\"input-group\">\r\n\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\"\r\n\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"Location of Incident\"\r\n\t\t\t\t\t\t\t\t\t\t\taria-describedby=\"basic-addon1\" [(ngModel)]=\"incidentCity\"\r\n\t\t\t\t\t\t\t\t\t\t\tname=\"incidentCity\" value={{incidentCity}}>\r\n\t\t\t\t\t\t\t\t\t</div></td>\r\n\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t<td bgcolor=\"red\" width=\"30%\"><font color=\"white\">State</font></td>\r\n\t\t\t\t\t\t\t\t<td width=\"70%\"><div class=\"input-group\">\r\n\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\"\r\n\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"Incident State\" aria-describedby=\"basic-addon1\"\r\n\t\t\t\t\t\t\t\t\t\t\t[(ngModel)]=\"incidentState\" name=\"incidentState\"\r\n\t\t\t\t\t\t\t\t\t\t\tvalue={{incidentState}}>\r\n\t\t\t\t\t\t\t\t\t</div></td>\r\n\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t<td bgcolor=\"red\" width=\"30%\"><font color=\"white\">Zip\r\n\t\t\t\t\t\t\t\t\t\tcode</font></td>\r\n\t\t\t\t\t\t\t\t<td width=\"70%\"><div class=\"input-group\">\r\n\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\"\r\n\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"Incident Zip Code\"\r\n\t\t\t\t\t\t\t\t\t\t\taria-describedby=\"basic-addon1\" [(ngModel)]=\"incidentZipCode\"\r\n\t\t\t\t\t\t\t\t\t\t\tname=\"incidentZipCode\" value={{incidentZipCode}}>\r\n\t\t\t\t\t\t\t\t\t</div></td>\r\n\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t<td bgcolor=\"red\" width=\"30%\"><font color=\"white\">Police\r\n\t\t\t\t\t\t\t\t\t\tRpt #</font></td>\r\n\t\t\t\t\t\t\t\t<td width=\"70%\"><div class=\"input-group\">\r\n\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\"\r\n\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"Police Dept/Report #\"\r\n\t\t\t\t\t\t\t\t\t\t\taria-describedby=\"basic-addon1\"\r\n\t\t\t\t\t\t\t\t\t\t\t[(ngModel)]=\"incidentPoliceRpt\" name=\"incidentPoliceRpt\"\r\n\t\t\t\t\t\t\t\t\t\t\tvalue={{incidentPoliceRpt}}>\r\n\t\t\t\t\t\t\t\t\t</div></td>\r\n\t\t\t\t\t\t</tbody>\r\n\t\t\t\t\t</table>\r\n\t\t\t\t</div>\r\n\t\t\t\t<br />\r\n\r\n\t\t\t\t<div class=\"panel panel-default\">\r\n\t\t\t\t\t<div class=\"panel-heading\">Insurance Details</div>\r\n\r\n\t\t\t\t\t<table class=\"table\">\r\n\t\t\t\t\t\t<tbody>\r\n\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t<td bgcolor=\"red\" width=\"30%\"><font color=\"white\">Name</font></td>\r\n\t\t\t\t\t\t\t\t<td width=\"70%\"><div class=\"input-group\">\r\n\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\"\r\n\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"Operators Insurance Co.\"\r\n\t\t\t\t\t\t\t\t\t\t\taria-describedby=\"basic-addon1\" [(ngModel)]=\"insuranceName\"\r\n\t\t\t\t\t\t\t\t\t\t\tname=\"insuranceName\" value={{insuranceName}}>\r\n\r\n\t\t\t\t\t\t\t\t\t</div></td>\r\n\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t<td bgcolor=\"red\" width=\"30%\"><font color=\"white\">Address</font></td>\r\n\t\t\t\t\t\t\t\t<td width=\"70%\"><div class=\"input-group\">\r\n\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\"\r\n\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"Operators Insurance Co.\"\r\n\t\t\t\t\t\t\t\t\t\t\taria-describedby=\"basic-addon1\"\r\n\t\t\t\t\t\t\t\t\t\t\t[(ngModel)]=\"insuranceAddress\" name=\"insuranceAddress\"\r\n\t\t\t\t\t\t\t\t\t\t\tvalue={{insuranceAddress}}>\r\n\t\t\t\t\t\t\t\t\t</div></td>\r\n\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t<td bgcolor=\"red\" width=\"30%\"><font color=\"white\">Is\r\n\t\t\t\t\t\t\t\t\t\tOperator's Details same as Renter ?</font></td>\r\n\t\t\t\t\t\t\t\t<td width=\"70%\">\r\n\t\t\t\t\t\t\t\t\t<!-- <div class=\"checkbox\">\r\n\t\t\t\t\t\t\t\t<label> <input type=\"checkbox\" data-toggle=\"toggle-one\"\r\n\t\t\t\t\t\t\t\t\t(click)=\"toggleRenter()\">\r\n\r\n\t\t\t\t\t\t\t\t</label>\r\n\t\t\t\t\t\t\t</div> --> <ui-switch color=\"red\" (change)=\"toggleRenter()\"></ui-switch>\r\n\r\n\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t</tbody>\r\n\t\t\t\t\t</table>\r\n\r\n\t\t\t\t\t<div *ngIf=\"operatorNotRenter\">\r\n\t\t\t\t\t\t<table class=\"table\">\r\n\t\t\t\t\t\t\t<tbody>\r\n\t\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t\t<td bgcolor=\"red\" width=\"30%\"><font color=\"white\">Name</font></td>\r\n\t\t\t\t\t\t\t\t\t<td width=\"70%\"><div class=\"input-group\">\r\n\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\"\r\n\t\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"Person operating vehicle\"\r\n\t\t\t\t\t\t\t\t\t\t\t\taria-describedby=\"basic-addon1\" [(ngModel)]=\"operatorName\"\r\n\t\t\t\t\t\t\t\t\t\t\t\tname=\"operatorName\" value={{operatorName}}>\r\n\t\t\t\t\t\t\t\t\t\t</div></td>\r\n\t\t\t\t\t\t\t\t</tr>\r\n\r\n\t\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t\t<td bgcolor=\"red\" width=\"30%\"><font color=\"white\">Contact</font></td>\r\n\t\t\t\t\t\t\t\t\t<td width=\"70%\"><div class=\"input-group\">\r\n\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\"\r\n\t\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"Operators contact number\"\r\n\t\t\t\t\t\t\t\t\t\t\t\taria-describedby=\"basic-addon1\"\r\n\t\t\t\t\t\t\t\t\t\t\t\t[(ngModel)]=\"operatorContact\" name=\"operatorContact\"\r\n\t\t\t\t\t\t\t\t\t\t\t\tvalue={{operatorContact}}>\r\n\t\t\t\t\t\t\t\t\t\t</div></td>\r\n\t\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t\t<td bgcolor=\"red\" width=\"30%\"><font color=\"white\">Email</font></td>\r\n\t\t\t\t\t\t\t\t\t<td width=\"70%\"><div class=\"input-group\">\r\n\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\"\r\n\t\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"Operator Email Address\"\r\n\t\t\t\t\t\t\t\t\t\t\t\taria-describedby=\"basic-addon1\" [(ngModel)]=\"operatorEmail\"\r\n\t\t\t\t\t\t\t\t\t\t\t\tname=\"operatorEmail\" value={{operatorEmail}}>\r\n\t\t\t\t\t\t\t\t\t\t</div></td>\r\n\t\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t\t<td bgcolor=\"red\" width=\"30%\"><font color=\"white\">Address</font></td>\r\n\t\t\t\t\t\t\t\t\t<td width=\"70%\"><div class=\"input-group\">\r\n\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\"\r\n\t\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"Operators Address\"\r\n\t\t\t\t\t\t\t\t\t\t\t\taria-describedby=\"basic-addon1\"\r\n\t\t\t\t\t\t\t\t\t\t\t\t[(ngModel)]=\"operatorAddress\" name=\"operatorAddress\"\r\n\t\t\t\t\t\t\t\t\t\t\t\tvalue={{operatorAddress}}>\r\n\t\t\t\t\t\t\t\t\t\t</div></td>\r\n\t\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t\t<td bgcolor=\"red\" width=\"30%\"><font color=\"white\">Zipcode</font></td>\r\n\t\t\t\t\t\t\t\t\t<td width=\"70%\"><div class=\"input-group\">\r\n\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\"\r\n\t\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"Operators Zip code\"\r\n\t\t\t\t\t\t\t\t\t\t\t\taria-describedby=\"basic-addon1\"\r\n\t\t\t\t\t\t\t\t\t\t\t\t[(ngModel)]=\"operatorZipCode\" name=\"operatorZipCode\"\r\n\t\t\t\t\t\t\t\t\t\t\t\tvalue={{operatorZipCode}}>\r\n\t\t\t\t\t\t\t\t\t\t</div></td>\r\n\t\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t\t<td bgcolor=\"red\" width=\"30%\"><font color=\"white\">License\r\n\t\t\t\t\t\t\t\t\t\t\tNumber</font></td>\r\n\t\t\t\t\t\t\t\t\t<td width=\"70%\"><div class=\"input-group\">\r\n\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\"\r\n\t\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"Operators Licensee Number\"\r\n\t\t\t\t\t\t\t\t\t\t\t\taria-describedby=\"basic-addon1\"\r\n\t\t\t\t\t\t\t\t\t\t\t\t[(ngModel)]=\"operatorLicenseNumber\"\r\n\t\t\t\t\t\t\t\t\t\t\t\tname=\"operatorLicenseNumber\"\r\n\t\t\t\t\t\t\t\t\t\t\t\tvalue={{operatorLicenseNumber}}>\r\n\t\t\t\t\t\t\t\t\t\t</div></td>\r\n\t\t\t\t\t\t\t\t</tr>\r\n\r\n\t\t\t\t\t\t\t</tbody>\r\n\t\t\t\t\t\t</table>\r\n\t\t\t\t\t</div>\r\n\r\n\t\t\t\t</div>\r\n\t\t\t\t<div class=\"panel panel-default\">\r\n\t\t\t\t\t<div class=\"panel-heading\">Car Damage Details</div>\r\n\t\t\t\t\t<table class=\"table\">\r\n\t\t\t\t\t\t<tbody>\r\n\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t<td bgcolor=\"red\" width=\"30%\"><font color=\"white\">Description</font></td>\r\n\t\t\t\t\t\t\t\t<td width=\"70%\"><div class=\"input-group\">\r\n\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\"\r\n\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"Provide damage description\"\r\n\t\t\t\t\t\t\t\t\t\t\taria-describedby=\"basic-addon1\"\r\n\t\t\t\t\t\t\t\t\t\t\t[(ngModel)]=\"damageDescription\" name=\"damageDescription\" value = {{damageDescription}}>\r\n\t\t\t\t\t\t\t\t\t</div></td>\r\n\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t<td bgcolor=\"red\" width=\"30%\"><font color=\"white\">Policy\r\n\t\t\t\t\t\t\t\t\t\tNumber</font></td>\r\n\t\t\t\t\t\t\t\t<td width=\"70%\"><div class=\"input-group\">\r\n\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\"\r\n\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"Enter Policy Number\"\r\n\t\t\t\t\t\t\t\t\t\t\taria-describedby=\"basic-addon1\" [(ngModel)]=\"policyNumber\"\r\n\t\t\t\t\t\t\t\t\t\t\tname=\"policyNumber\" value = {{policyNumber}}>\r\n\t\t\t\t\t\t\t\t\t</div></td>\r\n\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t<td bgcolor=\"red\" width=\"30%\"><font color=\"white\">Damage\r\n\t\t\t\t\t\t\t\t\t\tSeverity</font></td>\r\n\t\t\t\t\t\t\t\t<td width=\"70%\">\r\n\r\n\t\t\t\t\t\t\t\t\t<div class=\"form-group btn dropdown-toggle\">\r\n\t\t\t\t\t\t\t\t\t\t<select class=\"form-control\" id=\"sel1\" name = damageSeverity [(ngModel)]=\"damageSeverity\" value = {{damageSeverity}}>\r\n\t\t\t\t\t\t\t\t\t\t\t<option>Light</option>\r\n\t\t\t\t\t\t\t\t\t\t\t<option>Moderate</option>\r\n\t\t\t\t\t\t\t\t\t\t\t<option>Heavy</option>\r\n\t\t\t\t\t\t\t\t\t\t\t<option>Rolled</option>\r\n\t\t\t\t\t\t\t\t\t\t\t<option>Burned</option>\r\n\t\t\t\t\t\t\t\t\t\t</select>\r\n\t\t\t\t\t\t\t\t\t</div>\r\n\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t</tbody>\r\n\t\t\t\t\t</table>\r\n\t\t\t\t</div>\r\n\r\n\r\n\r\n\t\t\t\t<div class=\"panel panel-default\">\r\n\t\t\t\t\t<div class=\"panel-heading\">Other Vehicle/Property Damage\r\n\t\t\t\t\t\tdetails</div>\r\n\r\n\r\n\t\t\t\t\t<table class=\"table\">\r\n\t\t\t\t\t\t<tbody>\r\n\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t<td bgcolor=\"red\" width=\"30%\"><font color=\"white\">Other\r\n\t\t\t\t\t\t\t\t\t\tVehicles Involved ?</font></td>\r\n\t\t\t\t\t\t\t\t<td width=\"70%\">\r\n\t\t\t\t\t\t\t\t\t<!-- <div class=\"checkbox\">\r\n\t\t\t\t\t\t\t\t<label> <input type=\"checkbox\" data-toggle=\"toggle-one\"\r\n\t\t\t\t\t\t\t\t\t(click)=\"toggleHobbies()\">\r\n\r\n\t\t\t\t\t\t\t\t</label>\r\n\t\t\t\t\t\t\t</div> --> <ui-switch color=\"red\" (change)=\"toggleHobbies()\"></ui-switch>\r\n\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t</tbody>\r\n\t\t\t\t\t</table>\r\n\r\n\t\t\t\t\t<div *ngIf=\"showHobbies\">\r\n\t\t\t\t\t\t<table class=\"table\">\r\n\t\t\t\t\t\t\t<tbody>\r\n\r\n\r\n\t\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t\t<td bgcolor=\"red\" width=\"30%\"><font color=\"white\">Name</font></td>\r\n\t\t\t\t\t\t\t\t\t<td width=\"70%\"><div class=\"input-group\">\r\n\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\"\r\n\t\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"Owner of other vehicle/property\"\r\n\t\t\t\t\t\t\t\t\t\t\t\taria-describedby=\"basic-addon1\" [(ngModel)]=\"partyName\"\r\n\t\t\t\t\t\t\t\t\t\t\t\tname=\"partyName\" value = {{partyName}}>\r\n\t\t\t\t\t\t\t\t\t\t</div></td>\r\n\t\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t\t<td bgcolor=\"red\" width=\"30%\"><font color=\"white\">Address</font></td>\r\n\t\t\t\t\t\t\t\t\t<td width=\"70%\"><div class=\"input-group\">\r\n\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\"\r\n\t\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"Enter Address\" aria-describedby=\"basic-addon1\"\r\n\t\t\t\t\t\t\t\t\t\t\t\t[(ngModel)]=\"partyAddress\" name=\"partyAddress\" value = {{partyAddress}}>\r\n\t\t\t\t\t\t\t\t\t\t</div></td>\r\n\t\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t\t<td bgcolor=\"red\" width=\"30%\"><font color=\"white\">Phone</font></td>\r\n\t\t\t\t\t\t\t\t\t<td width=\"70%\"><div class=\"input-group\">\r\n\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\"\r\n\t\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"Contact Number\" aria-describedby=\"basic-addon1\"\r\n\t\t\t\t\t\t\t\t\t\t\t\t[(ngModel)]=\"partyContact\" name=\"partyContact\" value = {{partyPhone}}>\r\n\t\t\t\t\t\t\t\t\t\t</div></td>\r\n\t\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t\t<td bgcolor=\"red\" width=\"30%\"><font color=\"white\">Damage\r\n\t\t\t\t\t\t\t\t\t\t\tDescription</font></td>\r\n\t\t\t\t\t\t\t\t\t<td width=\"70%\"><div class=\"input-group\">\r\n\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\"\r\n\t\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"Provide Damage Description\"\r\n\t\t\t\t\t\t\t\t\t\t\t\taria-describedby=\"basic-addon1\"\r\n\t\t\t\t\t\t\t\t\t\t\t\t[(ngModel)]=\"partyDamageDescription\"\r\n\t\t\t\t\t\t\t\t\t\t\t\tname=\"partyDamageDescription\" value = {{partyDamageDescription}}>\r\n\t\t\t\t\t\t\t\t\t\t</div></td>\r\n\t\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t\t<td bgcolor=\"red\" width=\"30%\"><font color=\"white\">Drivable\r\n\t\t\t\t\t\t\t\t\t\t\tCar</font></td>\r\n\t\t\t\t\t\t\t\t\t<td width=\"70%\"><div class=\"checkbox\">\r\n\t\t\t\t\t\t\t\t\t\t\t<label> <input type=\"checkbox\"\r\n\t\t\t\t\t\t\t\t\t\t\t\tdata-toggle=\"toggle-one\" checked data-toggle=\"toggle\"\r\n\t\t\t\t\t\t\t\t\t\t\t\t[(ngModel)]=\"drivableCarInd\" name=\"drivableCarInd\" value = {{drivableCarInd}}>\r\n\r\n\t\t\t\t\t\t\t\t\t\t\t</label>\r\n\t\t\t\t\t\t\t\t\t\t</div></td>\r\n\t\t\t\t\t\t\t\t</tr>\r\n\r\n\t\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t\t<td bgcolor=\"red\" width=\"30%\"><font color=\"white\">Licensee\r\n\t\t\t\t\t\t\t\t\t\t\tPlate</font></td>\r\n\t\t\t\t\t\t\t\t\t<td width=\"70%\"><div class=\"input-group\">\r\n\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\"\r\n\t\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"Licensee Plate of Impacted Vehicle\"\r\n\t\t\t\t\t\t\t\t\t\t\t\taria-describedby=\"basic-addon1\"\r\n\t\t\t\t\t\t\t\t\t\t\t\t[(ngModel)]=\"partyLicensePlate\" name=\"partyLicensePlate\" value = {{partyLicensePlate}}>\r\n\t\t\t\t\t\t\t\t\t\t</div></td>\r\n\t\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t</tbody>\r\n\t\t\t\t\t\t</table>\r\n\t\t\t\t\t\t<!-- /<table width=\"400\" height = \"200\"><tr> -->\r\n\r\n\t\t\t\t\t\t<!-- \t<signature-pad [options]=\"signaturePadOptions\" (onBeginEvent)=\"drawStart()\" (onEndEvent)=\"drawComplete()\"></signature-pad> -->\r\n\t\t\t\t\t\t<!-- </tr>\r\n\t\t\t\t</table> -->\r\n\t\t\t\t\t</div>\r\n\t\t\t\t</div>\r\n\t\t\t\t<div class=\"panel panel-default\">\r\n\r\n\t\t\t\t\t<div class=\"panel-heading\">Additional References</div>\r\n\t\t\t\t\t<button type=\"button\" class=\"btn btn-sm\" data-toggle=\"modal\"\r\n\t\t\t\t\t\t(click)=\"addPhotos()\">Add Photo</button>\r\n\t\t\t\t\t<!-- <div *ngIf=\"additonalPhotos\"> -->\r\n\t\t\t\t\t\t<form>\r\n\t\t\t\t\t\t\t<table class=\"table\">\r\n\t\t\t\t\t\t\t\t<tbody>\r\n\t\t\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t\t\t\t<td width=\"50%\">\r\n\t\t\t\t\t\t\t\t\t\t\t<div id=\"camera5\"></div>\r\n\t\t\t\t\t\t\t\t\t\t\t<div class=\"input-group\" name=\"photo-one\">\r\n\t\t\t\t\t\t\t\t\t\t\t\t<input type=button value=\"Capture\"\r\n\t\t\t\t\t\t\t\t\t\t\t\t\t(click)=\"take_snapshot('camera5')\">\r\n\t\t\t\t\t\t\t\t\t\t\t</div>\r\n\t\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t</table>\r\n\t\t\t\t\t\t</form>\r\n\t\t\t\t\t<!-- </div> -->\r\n\t\t\t\t\t<button type=\"button\" class=\"btn btn-sm\" data-toggle=\"modal\"\r\n\t\t\t\t\t\t(click)=\"addPhotos2()\">Add Photo</button>\r\n\t\t\t\t\t<!-- <div *ngIf=\"additonalPhotos2\"> -->\r\n\t\t\t\t\t\t<form>\r\n\t\t\t\t\t\t\t<table class=\"table\">\r\n\t\t\t\t\t\t\t\t<tbody>\r\n\t\t\t\t\t\t\t\t\t<tr>\r\n\r\n\t\t\t\t\t\t\t\t\t\t<td width=\"50%\">\r\n\t\t\t\t\t\t\t\t\t\t\t<div id=\"camera6\"></div>\r\n\t\t\t\t\t\t\t\t\t\t\t<div class=\"input-group\" name=\"photo-one\">\r\n\t\t\t\t\t\t\t\t\t\t\t\t<input type=button value=\"Capture\"\r\n\t\t\t\t\t\t\t\t\t\t\t\t\t(click)=\"take_snapshot('camera6')\">\r\n\t\t\t\t\t\t\t\t\t\t\t</div>\r\n\t\t\t\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t</table>\r\n\t\t\t\t\t\t</form>\r\n\t\t\t\t\t<!-- </div> -->\r\n\r\n\t\t\t\t\t<button type=\"button\" class=\"btn btn-sm\" data-toggle=\"modal\"\r\n\t\t\t\t\t\t(click)=\"addSignature()\">Add Signature</button>\r\n\t\t\t\t\t<div *ngIf=\"addSignatureInd\">\r\n\t\t\t\t\t\t\r\n\t\t\t\t\t\t\t<signature-pad (onBeginEvent)=\"drawStart()\" (onEndEvent)=\"drawComplete()\"></signature-pad>\r\n\t\t\t\t\t\t\r\n\t\t\t\t\t</div>\r\n\t\t\t\t\t\r\n\t\t\t\t</div>\r\n\t\t\t\t<div class=\"text-center\">\r\n\t\t\t\t\t<button type=\"button\" class=\"btn btn-primary btn-sm\"\r\n\t\t\t\t\t\tdata-toggle=\"modal\" (click)=\"updateClaim()\">Update Claim\r\n\t\t\t\t\t\tDetails</button>\r\n\t\t\t\t</div>\r\n\r\n\t\t\t<div *ngIf=\"updateClaimSuccess\" class=\"alert alert-success box-msg\" role=\"alert\">\r\n\t\t\t        Claim details updated successfully\r\n\t\t\t</div>\r\n\t\t\t</div>\r\n\r\n\t\t\t<!-- \t<div class=\"panel panel-default\">\r\n\t\t\t<div class=\"panel-heading\">Other Vehicle/Property Damage\r\n\t\t\t\tdetails</div>\r\n\r\n\r\n\t\t\t<table class=\"table\">\r\n\t\t\t\t<tbody>\r\n\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t<td>Other Vehicles Involved ?</td>\r\n\t\t\t\t\t\t<td><div class=\"checkbox\">\r\n\t\t\t\t\t\t\t\t<label> <input type=\"checkbox\" data-toggle=\"toggle-one\"\r\n\t\t\t\t\t\t\t\t\t(click)=\"toggleHobbies()\">\r\n\r\n\t\t\t\t\t\t\t\t</label>\r\n\t\t\t\t\t\t\t</div></td>\r\n\t\t\t\t\t</tr>\r\n\t\t\t\t</tbody>\r\n\t\t\t</table>\r\n\r\n\t\t\t<div *ngIf=\"showHobbies\">\r\n\t\t\t\t<table class=\"table\">\r\n\t\t\t\t\t<tbody>\r\n\r\n\r\n\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t<td>Name</td>\r\n\t\t\t\t\t\t\t<td><div class=\"input-group\">\r\n\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\"\r\n\t\t\t\t\t\t\t\t\t\tplaceholder=\"Owner of other vehicle/property\"\r\n\t\t\t\t\t\t\t\t\t\taria-describedby=\"basic-addon1\"\r\n\t\t\t\t\t\t\t\t\t\t[(ngModel)]=\"partyName\" name = \"partyName\">\r\n\t\t\t\t\t\t\t\t</div></td>\r\n\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t<td>Address</td>\r\n\t\t\t\t\t\t\t<td><div class=\"input-group\">\r\n\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\"\r\n\t\t\t\t\t\t\t\t\t\tplaceholder=\"Enter Address\" aria-describedby=\"basic-addon1\"\r\n\t\t\t\t\t\t\t\t\t\t[(ngModel)]=\"partyAddress\" name = \"partyAddress\">\r\n\t\t\t\t\t\t\t\t</div></td>\r\n\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t<td>Phone</td>\r\n\t\t\t\t\t\t\t<td><div class=\"input-group\">\r\n\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\"\r\n\t\t\t\t\t\t\t\t\t\tplaceholder=\"Contact Number\" aria-describedby=\"basic-addon1\"\r\n\t\t\t\t\t\t\t\t\t\t[(ngModel)]=\"partyContact\" name = \"partyContact\">\r\n\t\t\t\t\t\t\t\t</div></td>\r\n\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t<td>Damage Description</td>\r\n\t\t\t\t\t\t\t<td><div class=\"input-group\">\r\n\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\"\r\n\t\t\t\t\t\t\t\t\t\tplaceholder=\"Provide Damage Description\"\r\n\t\t\t\t\t\t\t\t\t\taria-describedby=\"basic-addon1\" \r\n\t\t\t\t\t\t\t\t\t\t[(ngModel)]=\"partyDamageDescription\" name = \"partyDamageDescription\">\r\n\t\t\t\t\t\t\t\t</div></td>\r\n\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t<td>Drivable Car</td>\r\n\t\t\t\t\t\t\t<td><div class=\"checkbox\">\r\n\t\t\t\t\t\t\t\t\t<label> <input type=\"checkbox\" data-toggle=\"toggle-one\"\r\n\t\t\t\t\t\t\t\t\t\tchecked data-toggle=\"toggle\"\r\n\t\t\t\t\t\t\t\t\t\t[(ngModel)]=\"drivableCarInd\" name =\"drivableCarInd\">\r\n\r\n\t\t\t\t\t\t\t\t\t</label>\r\n\t\t\t\t\t\t\t\t</div></td>\r\n\t\t\t\t\t\t</tr>\r\n\r\n\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t<td>Licensee Plate</td>\r\n\t\t\t\t\t\t\t<td><div class=\"input-group\">\r\n\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\"\r\n\t\t\t\t\t\t\t\t\t\tplaceholder=\"Licensee Plate of Impacted Vehicle\"\r\n\t\t\t\t\t\t\t\t\t\taria-describedby=\"basic-addon1\"\r\n\t\t\t\t\t\t\t\t\t\t[(ngModel)]=\"partyLicensePlate\" name =\"partyLicensePlate\">\r\n\t\t\t\t\t\t\t\t</div></td>\r\n\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t</tbody>\r\n\t\t\t\t</table>\r\n\t\t\t</div>\r\n\t\t\t<div class=\"col-md-4 text-center\">\r\n\t\t\t\t<button type=\"button\" class=\"btn btn-primary btn-sm\"\r\n\t\t\t\t\tdata-toggle=\"modal\" data-target=\"#myModal\" (click)=\"createClaim()\">\r\n\t\t\t\t\tCreate Claim</button>\r\n\t\t\t</div> -->\r\n\r\n\r\n\t\t\t<!-- \t\t<h1>{{name}}</h1>\r\n\t\t<p>\r\n\t\t\t<strong>Email:</strong> {{email}}\r\n\t\t</p>\r\n\t\t<p>\r\n\t\t\t<strong>Address:</strong> {{address.street}} {{address.city}},\r\n\t\t\t{{address.state}}\r\n\t\t</p>\r\n\t\t<button class=\"btn btn-default btn-md\" style=\"cursor: pointer;\"\r\n\t\t\t(click)=\"toggleHobbies()\">{{showHobbies ? \"Hide Hobbies\" :\r\n\t\t\t\"Show Hobbies\"}}</button>\r\n\t\t<div *ngIf=\"showHobbies\">\r\n\t\t\t<h3>Car Photos</h3>\r\n\t\t\t<ul>\r\n\t\t\t\t<li *ngFor=\"let hobby of hobbies; let i = index\">{{hobby}}\r\n\t\t\t\t\t<button class=\"btn btn-success btn-delete btn-xs\"\r\n\t\t\t\t\t\t(click)=\"deleteHobby(i)\">X</button>\r\n\t\t\t\t</li>\r\n\t\t\t</ul>\r\n\t\t\t<form (submit)=\"addHobby(hobby.value)\">\r\n\t\t\t\t<label>Add Photo: </label><br /> <input type=\"text\" #hobby /><br />\r\n\t\t\t</form>\r\n\t\t</div>\r\n\t\t<hr />\r\n\t\t<h3>Edit User</h3>\r\n\t\t<form>\r\n\t\t\t<label>Name: </label><br /> <input type=\"text\" name=\"name\"\r\n\t\t\t\t[(ngModel)]=\"name\" /><br /> <label>Email: </label><br /> <input\r\n\t\t\t\ttype=\"text\" name=\"email\" [(ngModel)]=\"email\" /><br /> <label>Street:\r\n\t\t\t</label><br /> <input type=\"text\" name=\"address.street\"\r\n\t\t\t\t[(ngModel)]=\"address.street\" /><br /> <label>City: </label><br />\r\n\t\t\t<input type=\"text\" name=\"address.city\" [(ngModel)]=\"address.city\" /><br />\r\n\t\t\t<label>State: </label><br /> <input type=\"text\" name=\"address.state\"\r\n\t\t\t\t[(ngModel)]=\"address.state\" /><br />\r\n\t\t</form>\r\n\t\t<hr /> -->\r\n\r\n\t\t</div>\r\n\t</div>\r\n\t<!-- </div> -->\r\n\t<!--  <h3>Posts</h3>\r\n    <div *ngFor=\"let post of posts\">\r\n        <h3>{{post.title}}</h3>\r\n        <p>{{post.body}}</p>\r\n    </div> -->\r\n</div>"
