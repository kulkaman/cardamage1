...
var PostsService = (function () {
    ...
    PostsService.url = 'https://e70889e7.ngrok.io';
...
var AboutComponent = (function () {
     ...
     */
        if (this.posts) {
            ...
            this.pdfSrc = "https://e70889e7.ngrok.io/SpringMVC/pdf/" + this.posts[0].rentalAgreementNumber + "_file.pdf";
        }
    }
...
var UserComponent = (function () {
    function UserComponent(postsService, router) {
        ...
        if (this.posts) {
            ...
            this.pdfSrc = "https://e70889e7.ngrok.io/SpringMVC/pdf/" + this.rentalAgreementNumber + "_file.pdf";
        }
        if (this.coDate == null) {
