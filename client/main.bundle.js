...
var PostsService = (function () {
    ...
    PostsService.url = 'https://7da0bc58.ngrok.io';
...
var UserComponent = (function () {
    function UserComponent(postsService, router) {
        ...
        this.pdfSrc = 'https://7da0bc58.ngrok.io/SpringMVC/pdf/12345_file.pdf';
        this.markers = [];
        this.signaturePadOptions = {
            'minWidth': 5,
            'canvasWidth': 100,
    ...
    UserComponent.prototype.createClaim = function () {
        ...
        if (this.rentalAgreementNumber == null) {
            this.rentalAgreementNumber = "123456789";
            this.firstName = "John";
            this.lastName = "Smith";
